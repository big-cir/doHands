...
public class QuestController {
    ...
    public ResponseEntity<QuestStatisticsResponseDTO> getQuestStatistics(@AuthenticationPrincipal CustomUserDetails auth,
        @RequestBody QuestStatisticsRequestDTO request){
